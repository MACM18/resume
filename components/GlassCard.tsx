...
export function GlassCard({
  ...
  const variantStyles = {
    ...
    gradient: "bg-gradient-to-br from-glass-bg/15 via-glass-bg/5 to-transparent backdrop-blur-2xl border-glass-border/40",
  ...
  return (
    <motion.div
      className={cn(
        ...
        hover &&
          "hover:border-primary/50 hover:bg-glass-bg/20",
        hover &&
