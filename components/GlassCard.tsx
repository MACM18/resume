...
export function GlassCard({ children, className, hover = true, float = false }: GlassCardProps) {
  return (
    <motion.div
      className={cn(
        ...
        hover && "transition-all duration-300 hover:shadow-hover hover:scale-105 hover:border-primary/40 hover:bg-glass-bg/20",
        float && "animate-float",
        className
      )}
