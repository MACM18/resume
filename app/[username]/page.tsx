...
export default function Page({ params }: { params: { username: string } }) {
  const { data: profileData, isLoading } = useQuery({
    ...
    queryFn: () => getProfileData(params.username),
  });
      ...
      <div className="min-h-screen flex items-center justify-center text-center">
        <div>
          ...
          <p className="text-foreground/70">
            This user has not set up their portfolio yet.
          </p>
        </div>
      </div>
    );
      ...
      <div className='max-w-6xl mx-auto'>
        ...
        <div className='text-center mb-16'>
          ...
          >
            ...
            >
              <Link href={`/${params.username}/resume/developer`}>Download Resume</Link>
            </Button>
          </motion.div>
        </div>
        ...
        <div className='grid md:grid-cols-3 gap-8 mb-16'>
          ...
          >
            <GlassCard className='p-8 h-full' hover>
              ...
              >
                <Link href={`/${params.username}/resume/developer`}>
        ...
        >
          <GlassCard className='p-12'>
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              ...
              >
                <Link href={`/${params.username}/about`}>Learn More About Me</Link>
              </Button>
            </div>
          </GlassCard>
        </motion.div>
